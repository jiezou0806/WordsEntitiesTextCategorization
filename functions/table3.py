...
# Query Words in respect to Document Entities.
def table_3(documents, entities, indexes):
    DTM_name = None
    ...
    if os.path.isfile('datasets/table3/DTM_name.pic'):
        print('DTM name pickle found.')
        DTM_name = pd.read_pickle('datasets/table3/DTM_name.pic')
    else:
        (DTM_name, documents_dict_name, average_doc_length_name) = term_frequency(documents, entities_names, indexes, 1,                                                                          'name')
        DTM_name.to_pickle('./datasets/table3/DTM_name.pic')

    if os.path.isfile('datasets/table3/DTM_abstract.pic'):
        print('DTM abstract pickle found.')
        DTM_abstract = pd.read_pickle('datasets/table3/DTM_abstract.pic')
    else:
        ...
        DTM_abstract.to_pickle('./datasets/table3/DTM_abstract.pic')

    if os.path.isfile('datasets/table3/TFIDF_name.pic'):
        print('TFIDF name pickle found.')
        TFIDF_name = pd.read_pickle('datasets/table3/TFIDF_name.pic')
    else:
        ...
        TFIDF_name.to_pickle('./datasets/table3/TFIDF_name.pic')

    if os.path.isfile('datasets/table3/TFIDF_abstract.pic'):
        print('TFIDF abstract pickle found.')
        TFIDF_abstract = pd.read_pickle('datasets/table3/TFIDF_abstract.pic')
    else:
        ...
        TFIDF_abstract.to_pickle('./datasets/table3/TFIDF_abstract.pic')

    if os.path.isfile('datasets/table3/BM25_name.pic'):
        print('BM25 name pickle found.')
        BM25_name  = pd.read_pickle('datasets/table3/BM25_name.pic')
    else:
        if DTM_name is None or documents_dict_name is None or average_doc_length_name is None:
            (DTM_name, documents_dict_name, average_doc_length_name) = term_frequency(documents, entities_names, indexes, 1, 'name')
        ...
        BM25_name.to_pickle('./datasets/table3/BM25_name.pic')

    if os.path.isfile('datasets/table3/BM25_abstract.pic'):
        print('BM25 abstract pickle found.')
        BM25_abstract = pd.read_pickle('datasets/table3/BM25_abstract.pic')
    else:
        if DTM_abstract is None or documents_dict_abstract is None or average_doc_length_abstract is None:
            (DTM_abstract, documents_dict_abstract, average_doc_length_abstract) = term_frequency(documents, entities_description, indexes, 1,  'abstract')
        ...
        BM25_abstract.to_pickle('./datasets/table3/BM25_abstract.pic')

    if os.path.isfile('datasets/table3/BOOLEAN_name.pic'):
        print('BOOLEAN name pickle found.')
        BOOLEAN_name = pd.read_pickle('datasets/table3/BOOLEAN_name.pic')
    else:
        if DTM_name is None or documents_dict_name is None or average_doc_length_name is None:
            (DTM_name, documents_dict_name, average_doc_length_name) = term_frequency(documents, entities_names, indexes, 1, 'name')

        BOOLEAN_name = boolean(DTM_name, documents_dict_name)
        BOOLEAN_name.to_pickle('./datasets/table3/BOOLEAN_name.pic')

    if os.path.isfile('datasets/table3/BOOLEAN_abstract.pic'):
        print('BOOLEAN abstract pickle found.')
        BOOLEAN_abstract = pd.read_pickle('datasets/table3/BOOLEAN_abstract.pic')
    else:
        if DTM_abstract is None or documents_dict_abstract is None or average_doc_length_abstract is None:
            (DTM_abstract, documents_dict_abstract, average_doc_length_abstract) = term_frequency(documents, entities_description, indexes, 1, 'abstract')

        BOOLEAN_abstract = boolean(DTM_abstract, documents_dict_abstract)
        BOOLEAN_abstract.to_pickle('./datasets/table3/BOOLEAN_abstract.pic')

    if os.path.isfile('datasets/table3/LM_DS_name.pic'):
        print('LM_DS name pickle found.')
        LM_DS_name = pd.read_pickle('datasets/table3/LM_DS_name.pic')
    else:
        if DTM_name is None or documents_dict_name is None or average_doc_length_name is None:
            (DTM_name, documents_dict_name, average_doc_length_name) = term_frequency(documents, entities_names, indexes, 1, 'name')
        ...
        LM_DS_name.to_pickle('./datasets/table3/LM_DS_name.pic')

    if os.path.isfile('datasets/table3/LM_DS_abstract.pic'):
        print('LM_DS abstract pickle found.')
        LM_DS_abstract = pd.read_pickle('datasets/table3/LM_DS_abstract.pic')
    else:
        if DTM_abstract is None or documents_dict_abstract is None or average_doc_length_abstract is None:
            (DTM_abstract, documents_dict_abstract, average_doc_length_abstract) = term_frequency(documents, entities_description, indexes, 1, 'abstract')
        ...
        LM_DS_abstract.to_pickle('./datasets/table3/LM_DS_abstract.pic')
...
# Function to calculate the term frequency weights for Table 3
def term_frequency(documents, entities, indexes, approach = 1, mode = 'name'):
    ...
    for id in indexes:
        ...
        try:
            ...
            entities_words = " ".join(entities_id[mode])
            document_words = tokenize(document)
            avg_length_docs.append(len(entities_words))
            entities_words = tokenize(entities_words)

            if approach == 1:
                entities_words = ([x for x in document_words if x in entities_words])
